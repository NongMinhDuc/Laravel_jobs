...
// recommender 
Route::get('/job-suggestions', 'JobController@getSuggestions')->name('job.suggestions');

// Route gửi tin nhắn
Route::post('/messages/send', [MessageController::class, 'sendMessage'])->name('messages.send');
// Route lấy danh sách tin nhắn
Route::get('/messages/{jobId}', [MessageController::class, 'getMessages'])->name('messages.get');